"""Shared test fixtures for Ratify backend tests.
...
ADMIN_USER = UserInfo(
    ...
    email="admin@ratify.local",
    name="Admin User",
    role_id="00000000-0000-0000-0000-000000000010",
    role_name="Super Admin",
    permissions=[
        "rfcs.create", "rfcs.read", "rfcs.update", "rfcs.delete",
        "rfcs.sections.create", "rfcs.sections.update", "rfcs.sections.delete",
        "comments.create", "comments.read", "comments.update", "comments.delete",
        "reviews.create", "reviews.read", "reviews.update", "reviews.delete",
        "signoffs.create", "signoffs.read", "signoffs.update", "signoffs.delete",
        ...
        "ai.interview", "ai.refine", "ai.comment",
        "jira.sync",
    ],
)
...
VIEWER_USER = UserInfo(
    ...
    email="viewer@ratify.local",
    name="Viewer User",
    role_id="00000000-0000-0000-0000-000000000050",
    role_name="Viewer",
    permissions=["rfcs.read", "comments.read", "reviews.read", "signoffs.read"],
)
