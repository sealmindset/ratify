...
const navigationItems: SearchItem[] = [
  { label: "Dashboard", href: "/dashboard", keywords: ["home", "overview", "metrics"] },
  {
    label: "RFC Registry",
    href: "/rfcs",
    keywords: ["rfc", "request", "comment", "proposals", "list"],
    permission: { resource: "rfcs", action: "read" },
  },
  {
    label: "New RFC",
    href: "/rfcs/new",
    keywords: ["create", "new", "rfc", "interview", "ai"],
    permission: { resource: "rfcs", action: "create" },
  },
  {
    label: "My Reviews",
    href: "/reviews",
    keywords: ["review", "assigned", "pending", "tasks"],
    permission: { resource: "reviews", action: "read" },
  },
  {
    label: "User Management",
    href: "/admin/users",
    keywords: ["users", "admin", "people", "accounts"],
    permission: { resource: "admin.users", action: "read" },
  },
  {
    label: "Role Management",
    href: "/admin/roles",
    keywords: ["roles", "permissions", "admin", "access"],
    permission: { resource: "admin.roles", action: "read" },
  },
  {
    label: "Settings",
    href: "/admin/settings",
    keywords: ["settings", "config", "admin", "preferences"],
    permission: { resource: "admin.settings", action: "read" },
  },
  {
    label: "Activity Logs",
    href: "/admin/logs",
    keywords: ["logs", "activity", "monitoring", "requests", "admin"],
